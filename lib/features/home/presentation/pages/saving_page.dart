        ...
        children: [
              ...
              GlassBadge(
                child: Row(
                  ...
                  children: const [
                    ...
                    Text(
                      'Saving ledger',
                      style: TextStyle(fontSize: 12, color: _savingAccent),
                    ),
                  ],
                ),
              ),
          ...
          Wrap(
            ...
            children: [
              _HeaderMetricPill(
                label: 'Total saved',
                value: _usdCompact(totalSaved),
              ),
              _HeaderMetricPill(
                label: 'Still available',
                value: _usdCompact(activeAmount),
              ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: _savingAccent.withValues(alpha: 0.14),
          border: Border.all(color: _savingAccent.withValues(alpha: 0.22)),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: const [
