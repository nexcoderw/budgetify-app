...
enum ExpenseCategory {
  ...
  String get apiValue => switch (this) {
    ...
    ExpenseCategory.schoolFees => 'SCHOOL_FEES',
    ExpenseCategory.parentSibling => 'PARENT_SIBLING',
  ...
  String get displayName => switch (this) {
    ...
    ExpenseCategory.healthcare => 'Healthcare',
    ExpenseCategory.education => 'Education',
    ExpenseCategory.schoolFees => 'School fees',
    ExpenseCategory.parentSibling => 'Parent & sibling',
    ExpenseCategory.entertainment => 'Entertainment',
    ExpenseCategory.shopping => 'Shopping',
  ...
  static ExpenseCategory fromApi(String value) {
    return switch (value) {
      ...
      'AIRTIME' => ExpenseCategory.airtime,
      'HEALTHCARE' => ExpenseCategory.healthcare,
      'EDUCATION' => ExpenseCategory.education,
      'SCHOOL_FEES' => ExpenseCategory.schoolFees,
      'PARENT_SIBLING' => ExpenseCategory.parentSibling,
